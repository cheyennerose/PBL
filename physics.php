...
<div class="container">
    ...
    <div class="physicsintro">

        <h1 class="question">What is the force and energy of an arrow being shot?</h1>
    ...
    <div class="force">
        ...
        <div class="forcetext">
            ...
            <h1>Force</h1> You can determine the force of the string (string tension). According to Newton’s 2nd law: if you know the mass and acceleration of an object, you can determine its force. This statement forms into the equation:
